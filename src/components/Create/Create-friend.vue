<template>
  <div id="create-friend">
    <div class="friends" v-for="(l,idx) in lists" :key="idx">
      <p>{{l.Zhuyin}}</p>
      <div class="friend" v-for="(f,idx) in l.friends" :key="idx">
        <div class="image">
          <img :src="f.photo" alt="f.name" />
          <span v-if="f.isOnline === true" />
        </div>
        <div class="info">
          <p>{{f.name}}</p>
        ...
        <div class="check">
          <label :for="f.name" class="label">
            <input :id="f.name" type="checkbox" class="input" />
            <div class="checkbox">
